...
import com.infilos.relax.error.TableValidationException;
...
public class TableOtherTest {
    ...
    public void testReadFromValidJSONArrayWithSchema() throws Exception{
        ...
        Table table = Table.fromSource(populationTestJson, schema, DataSource.getDefaultCsvFormat());
        ...
        Table expectedTable = Table.fromSource(new File("data/population.csv")
            , getTestDataDirectory(), expectedSchema, DataSource.getDefaultCsvFormat());
    ...
    public void testReadFromValidJSONArrayWithExtendedSchema() throws Exception{
        ...
        Table table = Table.fromSource(new File("data/population.json")
            , getTestDataDirectory(), schema, DataSource.getDefaultCsvFormat());
    ...
    public void testInferTypesIntAndDates() throws Exception{
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode schema = objectMapper.readTree(table.inferSchema().toJsonString());
...
/*
    ...
    public void testIterateCastKeyedData() throws Exception{
        ...
        Table employeeTable = Table.fromSource(file, testDataDir, employeeTableSchema, DataSource.getDefaultCsvFormat());
    ...
    public void loadTableWithMismatchingSchema() throws Exception {
        ...
        Table table = Table.fromSource(file, testDataDir, schema, DataSource.getDefaultCsvFormat());
    ...
    public void saveTableAlternateSchema() throws Exception{
        ...
        Table loadedTable = Table.fromSource(file, testDataDir, schema, DataSource.getDefaultCsvFormat());
