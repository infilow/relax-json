...
public class TableCreationTest {
    ...
    public void testReadFromValidCSVContentString() throws Exception{
        ...
        Table table = Table.fromSource(csvContent, null, DataSource.getDefaultCsvFormat());
    ...
    public void testReadFromValidUrlAndValidSchemaURL() throws Exception{
        ...
        Table testTable = Table.fromSource(populationTestJson, testSchema, DataSource.getDefaultCsvFormat());
    ...
    public void testReadFromValidFileWithValidSchema() throws Exception{
        ...
        Table table = Table.fromSource(csvContent, schema, DataSource.getDefaultCsvFormat());
    ...
    public void testReadFromValidCSVFileWithValidSchemaViaStream() throws Exception{
        ...
        Table table = Table.fromSource(bis, fis, DataSource.getDefaultCsvFormat());
