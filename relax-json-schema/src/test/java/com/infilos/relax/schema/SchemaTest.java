...
import com.infilos.relax.beans.EmployeeBean;
...
public class SchemaTest extends Assert {
    ...
    public void testInferTypesComplexSchema() throws Exception {
        ...
        String schemaObjStr = table.inferSchema().toJsonString();
    ...
    public void testSaveDefaultBooleanValues() throws Exception {
        ...
        assertEquals("true", readSchema.getTypeField("isAdmin").formatValueAsString(true));
        assertEquals("false", readSchema.getTypeField("isAdmin").formatValueAsString(false));
        assertEquals("true", createdSchema.getTypeField("isAdmin").formatValueAsString(true));
        assertEquals("false", createdSchema.getTypeField("isAdmin").formatValueAsString(false));
    }
