...
public class LocalFileReference implements FileReference<File> {
    ...
    /**
     * Take a ZipFile and look for the `filename` entry. If it is not on the top-level, look for directories and go into them (but only one level deep) and look again for the `filename` entry
     *
