...
import com.infilos.relax.util.ReflectionUtils;
...
public class BeanSchema extends Schema {
    ...
    private Map<String, AnnotatedField> annotatedFieldMap;
    ...
    static Map<String, AnnotatedField> createAnnotatedFieldMap(Class<?> type) {
        ...
        BeanDescription desc = mapper.getSerializationConfig().introspect(jType);
